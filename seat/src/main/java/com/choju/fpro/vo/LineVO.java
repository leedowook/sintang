...
public class LineVO {
	...
	public String toString() {
		return "LineVO [C_col_num=" + C_col_num + ", C_num=" + C_num + ", C_hall_num=" + C_hall_num + ", C_col_name="
				+ C_col_name + ", C_row_count=" + C_row_count + ", C_col_priority=" + C_col_priority + "]";
	}
	public LineVO(String c_col_num, String c_num, String c_hall_num, String c_col_name, String c_row_count,
			String c_col_priority) {
		C_col_num = c_col_num;
		C_num = c_num;
		C_hall_num = c_hall_num;
		C_col_name = c_col_name;
