 ...
 // freeboard 메뉴 눌렸을때 나오는 화면(글목록)
	...
	// 이메일 인증 완료
	 ...
	 //닉네임 중복 인증 완료
	      ...
	      public String nickNameOverlap(@ModelAttribute MemberVO memberVO, HttpServletResponse response, HttpServletRequest request)
	            throws IOException {
	    ...
	    //회원정보 수정하기
	      ...
	      public void memberalert(@ModelAttribute alertMember alertmember, HttpServletResponse response, HttpServletRequest request)
	            throws IOException {
