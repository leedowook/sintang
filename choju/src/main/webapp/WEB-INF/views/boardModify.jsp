	...
	<div id="page">
		...
		<div id="colorlib-featured-product">
			<div align="center"> <!-- class="container" -->
				<div>
					<form action="boardmodify1" name="modify1" method="post" enctype="multipart/form-data" id="boardmodify1frm">
						...
						<table border=1 style="cellpadding:0;cellspacing:0;border-top:2px solid red;border-bottom:2px solid red;
							...
							<tr style="border-bottom:black;">
								<td colspan="5"><input type="text" id="editor" name="Board_Content" style="width:900px;height:500px;" value="${boardview.board_Content}"/></td>
								<!-- <input type="text" name="Board_Content" value="${boardview.board_Content }" style="height:100px;width:900px;"> -->
							</tr>
							...
							<tr>
								<td colspan="5" style="text-align:right;height:30px;">
									<a href="##" onclick="javascript:modify1.submit()" id="modifyBoard">작성하기</a> &nbsp;&nbsp;
