...
<body><h2>답글</h2>
<center>
<form action="boardWritePro.bo?property=recoment" method="post" enctype="multipart/form-data">
<input type="hidden" name="num" value="${listre.num}">
<input type="hidden" name="relev" value="${listre.relev}">
<input type="hidden" name="reseq" value="${listre.reseq}">
<input type="hidden" name="reref" value="${listre.reref}">
<table>
<tr>
